...
DB_CONTAINER_NAME="design-mysql"
...
docker run --name $DB_CONTAINER_NAME -e MYSQL_ROOT_PASSWORD=$DB_PASSWORD -e MYSQL_DATABASE=design -d -p 3306:3306 docker.io/mysql
